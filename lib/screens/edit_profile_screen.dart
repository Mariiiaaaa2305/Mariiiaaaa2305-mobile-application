    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              _buildTextField(_nameController, 'Повне ім\'я', Icons.person_outline),
              ...
              Row(
                children: [
                  Expanded(child: _buildTextField(_brandController, 'Марка', Icons.directions_car)),
                  const SizedBox(width: 10),
                  Expanded(child: _buildTextField(_modelController, 'Модель', Icons.edit_note)),
                ],
              ),
              const SizedBox(height: 15),
